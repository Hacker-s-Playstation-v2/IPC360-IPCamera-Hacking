...
앞면 | 뒷면
:-:|:-:
![image](https://user-images.githubusercontent.com/45416961/144432108-732ce75d-6dfd-44c6-84d5-639712237cab.png) |  ![image](https://user-images.githubusercontent.com/45416961/144432204-38b05889-cf72-4238-888e-ba0eae3ffa9b.png)

PCB에 프린팅 된 식별자 덕분에 멀티미터기 없이 `UART` 인터페이스를 쉽게 발견할 수 있었다. 인터페이스의 정확한 위치와 연결 방법은 아래 이미지를 참조하면 된다.
